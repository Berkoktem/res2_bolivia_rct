####################################################################################
####### Object:  Create a community-based dataset            
...
system(sprintf("gdal_calc.py -A %s -B %s -C %s --co COMPRESS=LZW --type=Byte --outfile=%s --calc=\"%s\"",
               ...
               paste0(gfc_dir,"defor_map_gfc16_th",thresh_gfc,".tif"),
...
system(sprintf("gdalwarp -srcnodata none -co COMPRESS=LZW -t_srs EPSG:32720 %s %s",
               paste0(gfc_dir,"defor_map_gfc16_th",thresh_gfc,".tif"),
               paste0(gfc_dir,"defor_map_gfc16_th",thresh_gfc,"_utm.tif")
))
...
system(sprintf("gdal_calc.py -A %s -B %s  --co COMPRESS=LZW --type=Byte --outfile=%s --calc=\"%s\"",
               paste0(gfc_dir,"gfc_2016_ly_",thresh_gfc,".tif"),
               paste0(anmi_dir,"/","community_boundaries/","communities_geo_20171129.tif"),
               paste0(gfc_dir,"gfc_2016_aoi_loss_2000_2010_",thresh_gfc,".tif"),
               paste0("(A>0)*(A<11)*(B>0)")
)
)
...
system(sprintf("gdalwarp -t_srs EPSG:32720 %s %s",
               paste0(gfc_dir,"gfc_2016_aoi_loss_2000_2010_",thresh_gfc,".tif"),
               paste0(gfc_dir,"gfc_2016_aoi_loss_2000_2010_",thresh_gfc,"_utm.tif")
               ))
...
system(sprintf("gdal_calc.py -A %s -B %s  --co COMPRESS=LZW --type=Byte --outfile=%s --calc=\"%s\"",
               paste0(gfc_dir,"gfc_2016_ly_",thresh_gfc,".tif"),
               paste0(anmi_dir,"/","community_boundaries/","communities_geo_20171129.tif"),
               paste0(gfc_dir,"gfc_2016_aoi_loss_2011_2016_",thresh_gfc,".tif"),
               paste0("(A>10)*(B>0)")
)
)
...
system(sprintf("gdalwarp -t_srs EPSG:32720 %s %s",
               paste0(gfc_dir,"gfc_2016_aoi_loss_2011_2016_",thresh_gfc,".tif"),
               paste0(gfc_dir,"gfc_2016_aoi_loss_2011_2016_",thresh_gfc,"_utm.tif")
))
