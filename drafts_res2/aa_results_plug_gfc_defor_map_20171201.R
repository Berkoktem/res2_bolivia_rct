...
map   <- raster(paste0(gfc_dir,"defor_map_gfc16_th",thresh_gfc,".tif"))
...
write.csv(df2,paste0(rootdir,"results_AA_tcc_map/map_vs_ref_20171201_th",thresh_gfc,".csv"),row.names = F)
...
system(sprintf("oft-stat -i %s -o %s -um %s -nostd",
               ...
               paste0(gfc_dir,"stats_defor_map_gfc16_th",thresh_gfc,".txt"),
               paste0(gfc_dir,"defor_map_gfc16_th",thresh_gfc,".tif")
))

areas <- read.table(paste0(gfc_dir,"stats_defor_map_gfc16_th",thresh_gfc,".txt"))[,1:2]
...
write.csv(areas_agg,paste0(gfc_dir,"stats_defor_map_gfc16_th",thresh_gfc,".csv"),row.names = F)
